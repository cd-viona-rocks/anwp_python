...
Die Anwendung soll die zentralen Abläufe aus dem **(TD002)** Aktivitäts- und **(TD003)** Zustandsdiagramm abbilden und auf den im **(TD004)** Klassendiagramm definierten Klassen und Attributen aufbauen **(TD005)**. 
 ...
 [ ] TODO **TD005** assumed: we can only use the methods and classes present in the two class diagrams
...
Die folgenden Kernfunktionen müssen in der Terminalversion enthalten und über ein einfaches Text-/Auswahlmenü bedienbar sein: 
 ...
 [O] TODO check activity / sequence diagrams here
 [O] TODO 
...
• [ ] **MR007** Lieferant aktualisiert den Status bis zur Zustellung 
 ...
 [ ] TODO document "this is a optional requirement OR"
...
• [ ] **DR001** Prüfen Sie das Klassendiagramm auf Vollständigkeit und Konsistenz zu den anderen Diagrammen (Attribute, Methoden, Beziehungen). 
• [ ] **DR002** Prüfen Sie, ob Aktivitäts- und Zustandsdiagramm zueinander passen (z. B. Bezeichnungen der Status/Übergänge). 
• [ ] **DR003** Wo Diagramme unklar, widersprüchlich oder lückenhaft sind, treffen Sie eine sinnvolle eigene Entscheidung und dokumentieren Sie diese kurz (siehe Punkt 5). 
• [ ] **DR004** Sie müssen keine Fehler "beheben", indem Sie die Diagramme selbst neu zeichnen – es reicht, den Code korrekt und nachvollziehbar zu gestalten. 
 ...
 [ ] TODO class diagramm check - DONE, see it
 [ ] TODO confront activity against state, document it
...
• [ ] **EX001** Bestellung stornieren (Abbruch) 
• [ ] **EX002** Pizza bewerten nach Zustellung 
• [ ] **EX003** Einfache Persistenz (z. B. Bestellungen in einer Datei/JSON zwischenspeichern) 
